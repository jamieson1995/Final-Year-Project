...
public class World {
	...
	/// Flag to determine if the scenario is over.
	...
	/// Flag to determine if the stockcages are all empty.
	public bool AllStockcagesEmpty;

	/// Flag to determine if the warehouse stock has all been worked.
	public bool AllWarehouseStockWorked;

	/// Flag to determine if all the facing up has been completed.
	public bool AllFacingUpFinished;

	/// Flag to determine if more checkout staff are required.
	...
	/// Removes the specifed character from the world.
